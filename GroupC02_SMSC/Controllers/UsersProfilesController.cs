...
namespace GroupC02_SMSC.Controllers
{
    public class UsersProfilesController : Controller
    {
        ...
        public IActionResult LoadTProfilesData()
        {
            try
            {
                var draw = HttpContext.Request.Form["draw"].FirstOrDefault();
                ...
                var v = _IRepository.TeacherinformationList(sortColumn, sortColumnDir, searchValue);
                recordsTotal = v.Count();
                var data = v.Skip(skip).Take(pageSize).ToList();
                return Json(new { draw = draw, recordsFiltered = recordsTotal, recordsTotal = recordsTotal, data = data });
            }
        ...
        public IActionResult Delete(string id)
        {
            try
            {
                ...
                int result = _IRepository.DeleteStudent(Convert.ToInt32(id));
